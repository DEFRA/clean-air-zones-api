...
import uk.gov.caz.whitelist.configuration.properties.SwaggerApiInfo;
...
public class SwaggerConfiguration {
  ...
  public Docket api(TypeResolver typeResolver, SwaggerApiInfo swaggerApiInfo) {
    return new Docket(DocumentationType.SWAGGER_2)
        ...
        .select()
        .apis(RequestHandlerSelectors.basePackage("uk.gov.caz.whitelist.controller"))
        .build()
        .apiInfo(new ApiInfo(
        ...
        .additionalModels(
            typeResolver.resolve(WhitelistedVehicleDto.class),
