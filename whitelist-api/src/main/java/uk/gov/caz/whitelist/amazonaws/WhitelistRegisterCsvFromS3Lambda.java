...
import uk.gov.caz.whitelist.service.RegisterResult;
import uk.gov.caz.whitelist.service.SourceAwareRegisterService;

@Slf4j
public class WhitelistRegisterCsvFromS3Lambda implements
