...
import uk.gov.caz.whitelist.controller.exception.InvalidRequestPayloadException;
...
public class WhitelistInfoHistoricalRequest {

  private static final Map<Function<WhitelistInfoHistoricalRequest, Boolean>, String> validators =
      ImmutableMap.<Function<WhitelistInfoHistoricalRequest, Boolean>, String>builder()
  ...
  @ApiModelProperty(value =
      "${swagger.model.descriptions.whitelist-info-historical-request.start-date}")
  @DateTimeFormat(iso = ISO.DATE)
  LocalDate startDate;

  @ApiModelProperty(value =
      "${swagger.model.descriptions.whitelist-info-historical-request.end-date}")
  @DateTimeFormat(iso = ISO.DATE)
  LocalDate endDate;

  @ApiModelProperty(value =
      "${swagger.model.descriptions.whitelist-info-historical-request.page-number}")
  Integer pageNumber;

  @ApiModelProperty(value =
      "${swagger.model.descriptions.whitelist-info-historical-request.page-size}")
  Integer pageSize;
   ...
   */
  private static Function<WhitelistInfoHistoricalRequest, Boolean> startDateNotNull() {
   ...
   */
  private static Function<WhitelistInfoHistoricalRequest, Boolean> endDateNotNull() {
   ...
   */
  private static Function<WhitelistInfoHistoricalRequest, Boolean> startBeforeEndDate() {
   ...
   */
  private static Function<WhitelistInfoHistoricalRequest, Boolean> pageNumberPositiveValue() {
   ...
   */
  private static Function<WhitelistInfoHistoricalRequest, Boolean> pageSizePositiveValue() {
