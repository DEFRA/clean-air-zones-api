...
public class RegisterJobRepository {
  ...
  private static final String COL_UPLOADER_ID = "uploader_id";
  static final String COL_REGISTER_JOB_ID = "register_job_id";
  static final String COL_TRIGGER = "trigger";
  ...
  private static String selectAllColumns() {
    return "SELECT rj." + COL_REGISTER_JOB_ID + ", "
        ...
        + "FROM caz_whitelist_vehicles.t_whitelist_job_register rj ";
  }
  ...
  private static final String SELECT_COUNT_BY_TRIGGER_AND_STATUS =
      "SELECT count(*) FROM caz_whitelist_vehicles.t_whitelist_job_register WHERE " + COL_TRIGGER
          + " = ? "
          + "AND (" + COL_STATUS + " = \'" + RegisterJobStatus.STARTING
          + "\' OR " + COL_STATUS + " = \'" + RegisterJobStatus.RUNNING + "\')";

  private static final String UPDATE_STATUS_SQL =
      "UPDATE caz_whitelist_vehicles.t_whitelist_job_register "
          + "SET "
          + COL_STATUS + " = ?, "
          + "last_modified_timestmp = CURRENT_TIMESTAMP "
          + "WHERE " + COL_REGISTER_JOB_ID + " = ?";

  private static final String UPDATE_ERRORS_SQL =
      "UPDATE caz_whitelist_vehicles.t_whitelist_job_register "
          + "SET "
          + COL_ERRORS + " = ?, "
          + "last_modified_timestmp = CURRENT_TIMESTAMP "
  ...
  public RegisterJobRepository(JdbcTemplate jdbcTemplate,
    ...
    jdbcInsert = new SimpleJdbcInsert(jdbcTemplate)
        .withTableName("caz_whitelist_vehicles.t_whitelist_job_register")
