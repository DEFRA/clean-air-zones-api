...
import uk.gov.caz.whitelist.dto.CloudWatchDataMessage;
import uk.gov.caz.whitelist.dto.CloudWatchDataMessage.LogEvent;
import uk.gov.caz.whitelist.dto.RegisterCsvFromS3LambdaInput;
...
public class RuntimeExceptionHandlerLambda implements RequestStreamHandler  {
  ...
  public static class EventProcessor {
     ...
     * @throws IOException If the function is unable to cancel the Job
     */
