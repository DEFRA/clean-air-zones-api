...
class CsvWhitelistedVehicleParserTest {

  @Mock
  private ICSVParser delegate;

  @InjectMocks
  private CsvWhitelistedVehicleParser parser;
  private static final String[] ANY_VALID_OUTPUT = new String[]{"1", "2", "3", "4", "5"};

  @ParameterizedTest
  @ValueSource(strings = {
      "comma ND84VSX,Exemption,category-3,model-3,2019-04-14",
      "underscore ND84VSX,Early Adopter,category-3,model_3,2019-04-14",
      "space ND84VSX,Non-UK Vehicle,category-3,model 3,2019-04-14",
      "ampersand ND84VSX&,Problematic VRN,category-3,model-3,2019-04-14",
      "apostrophe ND84V'SX',Other,category-3,model-3,2019-04-14",
      "left parenthesis (ND84VSX,Other,category-3,model-3,2019-04-14(",
      "right parenthesis )OND84VSX,Other,category-3,model-3,2019-04-14(",
      "asterisk N*D84VSX,Other,category-3,model-3,2019-04-14",
      "dot ND84VSX,Other,categor.y-3,mod.el-3,2019-04-14",
      "slash ND84VSX,Other,category-3,model-3,20/19-04-14",
      "percent sign ND84VSX,Other,category-3,model-%3,2019-04-14",
      "exclamation mark !ND84VSX,Other,category-3,model-3,2019-04-14!",
      "plus sign ND84VSX+,Other,category-3,model-3,2019-04-1+4",
      "colon ND84VSX,Other,cat:egory-3,:model-3,2019-04-14",
      "equals sign ND84VSX,Other,category-3,model-3,2019-04=14",
      "question mark ND84VSX,Other,cate?gory-3,mode?l-3,2019-04-14",
      "at sign ND84VSX,Other,cate@gory-3,model-3,2@019-04-14",
      "left square bracket [ND84VSX,Other,category-3,model-3,2019-[04-14",
      "right square bracket ]ND84VSX,Other,category-3,model-3,2019-04]-14",
      "circumflex accent ^ND84VSX,Other,category-3,model-3,^2019-04-14",
      "left curly bracket {ND84VSX,Other,category-3,model-3,2019-04-{14",
      "right curly bracket }ND84VSX,Other,category-3,model-3,2019-04-14}",
      "tilde ~ND84VSX,Other,category-3,model-3,2019-~04-14",
  })
  ...
  @Test
  public void shouldTrimLinesWithWhitespaceInPostProcessing() throws IOException {
    // given
    String line = "a,b ,c, d, e";
    given(delegate.parseLineMulti(line)).willReturn(new String[]{"a", "b ", "c", "d", "e"});
  ...
  public void shouldRejectTooLongLine() {
    // given
    String line = Strings.repeat("a", CsvWhitelistedVehicleParser.MAX_LINE_LENGTH + 1);
  ...
  public void shouldCallDelegateWhenCallingParseLineMulti() throws IOException {
    // given
    String line = "ND84VSX,Exemption,category-3,model-3,2019-04-14";
    given(delegate.parseLineMulti(line)).willReturn(ANY_VALID_OUTPUT);
