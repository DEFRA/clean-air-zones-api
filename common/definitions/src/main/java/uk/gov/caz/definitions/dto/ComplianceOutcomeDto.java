...
public class ComplianceOutcomeDto {
  ...
  @ApiModelProperty(value = "${swagger.model.descriptions.complianceResult.tariffCode}")
  String tariffCode;
  
  @ApiModelProperty(value = "${swagger.model.descriptions.informationUrls.description}")
  InformationUrlsDto informationUrls;

  @ApiModelProperty(value = "${swagger.model.descriptions.complianceResult.operatorName")
  String operatorName;
}
