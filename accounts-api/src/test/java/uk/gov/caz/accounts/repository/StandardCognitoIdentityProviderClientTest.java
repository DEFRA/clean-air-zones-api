...
class StandardCognitoIdentityProviderClientTest {

  @Mock
  private CognitoIdentityProviderClient cognitoClientProviderClient;

  private StandardCognitoIdentityProviderClient identityProviderClient;
  ...
  public void setup() throws Exception {
    ...
    identityProviderClient = new StandardCognitoIdentityProviderClient(
        cognitoClientProvider
    );
  }

  @Test
  public void shouldCalllistUsersWithProvidedRequest() {
    //given
