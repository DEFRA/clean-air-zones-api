...
import uk.gov.caz.accounts.service.generatecsv.exception.PresignedUrlException;
...
class CsvUrlGeneratorTest {
  ...
  private void prepareS3ClientToThrow() {
    given(s3Presigner.presignGetObject(any(GetObjectPresignRequest.class))).willThrow(mockS3Exception());
  }
