...
public class RegisterJobStatusDtoTest {
  ...
  static Stream<Arguments> statusCodeAndCustomCodeProvider() {
    return Stream.of(
        ...
        Arguments.arguments(RegisterJobStatus.CHARGEABILITY_CALCULATION_IN_PROGRESS,
            RegisterJobStatusDto.CHARGEABILITY_CALCULATION_IN_PROGRESS)
    );
  }
