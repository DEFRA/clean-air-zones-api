...
public class InactiveFor165DaysEmailSender {

  private final InactiveFor165DaysEmailService inactiveFor165DaysEmailService;
  ...
  public void send(String email, EmailContext context) {
    ...
    SendEmailRequest request = inactiveFor165DaysEmailService.buildSendEmailRequest(email, context);
