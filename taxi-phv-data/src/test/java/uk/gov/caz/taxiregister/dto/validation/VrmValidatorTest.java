...
class VrmValidatorTest {
  ...
  class MandatoryField {
    ...
    class WithLineNumber {
      ...
      @Test
      public void shouldReturnMissingFieldErrorWhenVrmIsEmpty() {
        // given
        int lineNumber = 92;
        String vrm = "";
        VehicleDto licence = createLicenceWithLineNumber(vrm, lineNumber);
  ...
  class Format {
    ...
    class WithLineNumber {
      ...
      @Test
      public void shouldReturnValueErrorWhenVrmIsTooLong() {
        // given
        String vrm = RandomStringUtils.randomAlphanumeric(VrmValidator.MAX_LENGTH + 1);
        int lineNumber = 87;
        VehicleDto licence = createLicenceWithLineNumber(vrm, lineNumber);
      ...
      public void shouldRejectVrmsWithInvalidFormat(String invalidVrm) {
        ...
        then(validationErrors).containsExactly(
            ValidationError
                .valueError(invalidVrm, VrmValidator.INVALID_VRM_FORMAT_MESSAGE, lineNumber)
        );
      }
    }
