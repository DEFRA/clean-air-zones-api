...
public class M2VehicleIdentificationStepdefs {
  ...
  @Given("that my vehicle has a seating capacity less than {int} seats")
  public void that_my_vehicle_seating_capacity_less_than_x_seats(int seats) {
    world.vehicle.setSeatingCapacity(seats - 1);
  }
  ...
  public void my_vehicle_is_identified_as_small_van() {
    assertEquals(VehicleType.SMALL_VAN, world.vehicle.getVehicleType());
  }

  @Then("my vehicle is identified as a large van")
  public void my_vehicle_is_identified_as_large_van() {
    assertEquals(VehicleType.LARGE_VAN, world.vehicle.getVehicleType());
  }
