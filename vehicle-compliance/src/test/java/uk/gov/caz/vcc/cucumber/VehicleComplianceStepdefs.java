...
public class VehicleComplianceStepdefs {
  private String leedsCazIdentifier = "39e54ed8-3ed2-441d-ffd5-38fc9b7048d3";
  ...
  public void that_my_vehicle_type_is_a(String vehicleType) {
    ...
    world.result.setCazIdentifier(
        UUID.fromString("39e54ed8-3ed2-441d-ffd5-38fc9b7048d3"));
  }
  ...
  public void i_have_entered_the_leeds_caz() {
    world.result.setCazIdentifier(UUID.fromString(leedsCazIdentifier));
  }
