/* JAQU-CAZ MVP Reporting - Requirement 1.1
Total number of vehicles by Vehicle Type Approval and DVLA Fuel Type entering a CCAZ
Author: Informed */

CREATE OR REPLACE VIEW caz_reporting.report_1_total_per_caz_per_day AS
-- Total number of vehicles by Vehicle Type Approval and Fuel Type entering a CCAZ by CCAZ per day
...
CREATE OR REPLACE VIEW caz_reporting.report_1_total_nationally_per_day AS
-- Total number of vehicles by Vehicle Type Approval and Fuel Type entering a CCAZ nationally per day
	SELECT DATE_TRUNC('day', hour) as Day,
	type_approval, 
	fuel_type, 
	COUNT(*) 
...
CREATE OR REPLACE VIEW caz_reporting.report_1_total_nationally_per_hour AS
