...
DROP TRIGGER IF EXISTS T_NATIONAL_WHITELIST_TYPE_AUDIT ON public.t_national_whitelist_type;
DROP TRIGGER IF EXISTS T_WHITELIST_DISCOUNT_CODE_AUDIT ON public.t_whitelist_discount_code;
...
CREATE TRIGGER T_NATIONAL_WHITELIST_TYPE_AUDIT
AFTER INSERT OR UPDATE OR DELETE ON T_NATIONAL_WHITELIST_TYPE
FOR EACH ROW EXECUTE PROCEDURE audit.if_modified_func();

CREATE TRIGGER T_WHITELIST_DISCOUNT_CODE_AUDIT
