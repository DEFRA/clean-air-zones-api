...
public class EuroStatusNullComplianceService implements CazComplianceService {
  ...
  private BiPredicate<Date,Date> isRegistrationDateAfter =  (registrationDate, cutoverDate) -> !registrationDate.before(cutoverDate);
  ...
  private static final Date EURO_TBD;
  ...
  static {
    try {
      ...
      EURO_TBD = dateFormatter.parse("2016-09-01");
