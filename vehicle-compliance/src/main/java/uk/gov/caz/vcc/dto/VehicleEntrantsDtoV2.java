...
import uk.gov.caz.vcc.dto.validation.VehicleEntrantTimestampValidatorV2;
...
/**
 * Wrapper class for Vehicle Entrants V2 API request object.
 */
@Value
@Builder
@AllArgsConstructor
public class VehicleEntrantsDtoV2 {
  ...
  private static final List<VehicleEntrantValidator<String>> VALIDATORS =
      ImmutableList.<VehicleEntrantValidator<String>>builder()
          ...
          .add(VehicleEntrantTimestampValidatorV2.INSTANCE)
          .build();
